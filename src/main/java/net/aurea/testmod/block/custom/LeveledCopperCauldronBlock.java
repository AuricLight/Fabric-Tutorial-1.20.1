 ...
 */
public class LeveledCopperCauldronBlock extends AbstractCauldronBlock {
     ...
     */
    public LeveledCopperCauldronBlock(AbstractBlock.Settings settings, Predicate<Biome.Precipitation> precipitationPredicate, Map<Item, CauldronBehavior> behaviorMap) {
    ...
    public static void decrementFluidLevel(BlockState state, World world, BlockPos pos) {
        ...
        BlockState blockState = i == 0 ? ModBlocks.COPPER_CAULDRON.getDefaultState() : state.with(LEVEL, i);
